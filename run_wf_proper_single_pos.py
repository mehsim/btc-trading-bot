...
print(f"=== TRUE PER-SYMBOL PROPER WALK-FORWARD BACKTEST ({eval_threshold}) ===")
...
print("\n--- PER-WINDOW TAKEN VS SKIPPED SIGNALS (CORRECT PER-SYMBOL INDEXING) ---")
...
for w in range(N_WINDOWS):
    ...
    if w == 1:
        print("\n=== WINDOW 2: FIRST 30 TRADES (CORRECTED) ===")
        for t in trades[:30]:
...
print(f"\n===================================================================================")
print(f"   CORRECTED PROPER WALK-FORWARD SUMMARY WITH LIVE POSITION GUARD")
print(f"===================================================================================")
