...
REALIZED_RR_HAIRCUT = 0.75        # Realistic empirical limit maker realization factor (75% target capture)
...
TIMEFRAME_CONFIG = {
    ...
    "120": {  # 2H Timeframe - Extended Swing
        "lookahead": int(_get_tf_env("TF_120M_LOOKAHEAD", 16)),
        "sl_mult": _get_tf_env("TF_120M_SL_MULT", 1.25),
        "base_confidence_threshold": _get_tf_env("TF_120M_CONF_THRESH", 0.50),
        "min_direction_mass": _get_tf_env("TF_120M_MIN_DIR_MASS", 0.15),
        "tp_mult_ranging": _get_tf_env("TF_120M_TP_RANGING", 1.40),
        "tp_mult_trending": _get_tf_env("TF_120M_TP_TRENDING", 2.20),
        "max_brier": _get_tf_env("TF_120M_MAX_BRIER", 0.67),
        "order_type": "POST_ONLY_LIMIT",
        "post_only": True
    },
