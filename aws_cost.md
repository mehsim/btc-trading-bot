...
* **Total Active Duration**: **5 hours, 22 minutes** (`5.37 hours`)
* **Cumulative Compute Cost**: **`$0.0731`**
* **Cumulative Storage Cost**: **`$0.0047`**
* **Total AWS Expenses to Date**: **`$0.0778`** (approx. **7.8 cents**)
