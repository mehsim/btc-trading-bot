...
# Step 1: Lock in ADX Gate Threshold (DO NOT ALTER POST-HOC)
ADX_4H_MIN = 22.0
...
print(f"=== 60M 4H-ADX GATED PASS (NORMAL vs FLIPPED) ===")
...
symbol_dfs = {}
print("Loading 60m candle history & building 4H ADX for 9 symbols...")
...
print("=" * 105)
print(f"   60M GATED WALK-FORWARD COMPARISON SUMMARY (ADX_4H >= {ADX_4H_MIN})")
print("=" * 105)
...
# Overall Gross PF Across All Trades
all_pnls_n = []
all_pnls_f = []

print(f"\nAGGREGATED STATS (GATED NORMAL):")
...
print(f"\nAGGREGATED STATS (GATED FLIPPED):")
